...
const Header = () => {
  ...
  const { products, userInfo, orderCount, favoriteProducts } = useSelector(
      ...
      <Container className="py-4 lg:py-6 flex items-center gap-x-3 md:gap-x-7 justify-between">
        ...
        <div className="hidden md:inline-flex items-center gap-4 lg:gap-x-6 text-sm uppercase font-medium text-gray-700">
          ...
          <a
            ...
            className="hover:text-black duration-300 relative group overflow-hidden px-1 py-2 transition-colors text-gray-700"
          >
            <div className="relative flex items-center">Admin Login</div>
          </a>
        ...
        <div className="flex items-center gap-x-2 md:gap-x-4">
          ...
          >
            ...
            {favoriteProducts?.length > 0 && (
              <span className="absolute -right-1 -top-1 w-5 h-5 rounded-full text-[10px] bg-red-500 text-white flex items-center justify-center font-bold">
                  ...
                  {headerNavigation?.map((item) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        />
                        {item?.title}
                        {item.link === "/wishlist" && favoriteProducts?.length > 0 && (
