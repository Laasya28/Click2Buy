          ...
          <div className="mt-12 p-6 bg-gray-50 rounded-xl">
            ...
            <div className="text-left text-sm text-gray-600 space-y-2">
              <div className="flex justify-between p-2 bg-white rounded border">
                ...
                <span className="text-green-600 font-semibold">₹2,999</span>
              </div>
              <div className="flex justify-between p-2 bg-white rounded border">
                <span>Order #87654321</span>
                <span className="text-green-600 font-semibold">₹4,595</span>
              </div>
              <div className="flex justify-between p-2 bg-white rounded border">
                <span>Order #45678912</span>
                <span className="text-green-600 font-semibold">₹1,297</span>
              </div>
